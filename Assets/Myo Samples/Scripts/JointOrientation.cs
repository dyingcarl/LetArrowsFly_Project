...
public class JointOrientation : MonoBehaviour
{
    ...
    //private Quaternion _antiYawArrow = Quaternion.identity;
    ...
    void Update ()
    {
        ...
        if (updateReference) {
           ...
           // _antiYawArrow = Quaternion.FromToRotation(
           //     new Vector3(myo.transform.forward.x, 0, myo.transform.forward.z),
        ...
        //Arrow.transform.rotation = _antiYawArrow * antiRoll * Quaternion.LookRotation(myo.transform.forward);
